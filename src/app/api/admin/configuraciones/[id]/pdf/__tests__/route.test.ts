...
vi.mock("@/lib/pdf/PedidoDocumentBilingual", () => ({ PedidoDocumentBilingual: vi.fn(() => "doc") }));
...
const CONFIG = {
  ...
  materiales: { exterior: "gris" },
};

describe("GET /api/admin/configuraciones/[id]/pdf", () => {
  ...
  it("200 con el PDF y el nombre de archivo derivado del cliente", async () => {
    ...
    expect(res.headers.get("Content-Disposition")).toBe(
      'attachment; filename="pedido-juan-garcía.pdf"'
    );
