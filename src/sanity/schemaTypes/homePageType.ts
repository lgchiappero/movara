    ...
    defineField({
      ...
      fields: [
        ...
        defineField({
          ...
          type: 'string',
          initialValue: 'Showroom MOVARA en Sunchales, Santa Fe',
        }),
        defineField({
          name: 'showroomDesc',
          ...
          type: 'text',
          rows: 2,
          initialValue: 'Recorré un modelo real, tocá los materiales y hablá con nuestro equipo.',
        }),
        defineField({
          name: 'showroomChip',
          title: 'Chip del showroom',
          type: 'string',
          initialValue: 'Visitas con turno',
        }),
      ],
    }),
